...
class SelfExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const SelfExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _SelfExpansionTileState createState() => _SelfExpansionTileState();
}

class _SelfExpansionTileState extends State<SelfExpansionTile>
